      ...
      <div className={`relative ${dpadSize} pointer-events-auto group`}>
        <div className={`absolute top-0 left-1/2 -translate-x-1/2 rounded-t-xl bg-background/90 border border-border shadow-lg active:bg-primary/20 backdrop-blur ${btnSize} flex items-center justify-center cursor-pointer transition-colors`}
          onPointerDown={handleStart("ArrowUp")} onPointerUp={handleEnd("ArrowUp")} onPointerLeave={handleEnd("ArrowUp")} onPointerCancel={handleEnd("ArrowUp")}>
            <ChevronUp className={`${iconSize} text-primary`} />
        </div>
        <div className={`absolute bottom-0 left-1/2 -translate-x-1/2 rounded-b-xl bg-background/90 border border-border shadow-lg active:bg-primary/20 backdrop-blur ${btnSize} flex items-center justify-center cursor-pointer transition-colors`}
          onPointerDown={handleStart("ArrowDown")} onPointerUp={handleEnd("ArrowDown")} onPointerLeave={handleEnd("ArrowDown")} onPointerCancel={handleEnd("ArrowDown")}>
            <ChevronDown className={`${iconSize} text-primary`} />
        </div>
        <div className={`absolute left-0 top-1/2 -translate-y-1/2 rounded-l-xl bg-background/90 border border-border shadow-lg active:bg-primary/20 backdrop-blur ${btnSize} flex items-center justify-center cursor-pointer transition-colors`}
        ...
        <div className={`absolute right-0 top-1/2 -translate-y-1/2 rounded-r-xl bg-background/90 border border-border shadow-lg active:bg-primary/20 backdrop-blur ${btnSize} flex items-center justify-center cursor-pointer transition-colors`}
