...
export const games: GameInfo[] = [
  ...
  },
  {
    ...
    difficulty: "Hard",
    tutorial: [
      "You have a set of uniquely shaped pieces to place on the board.",
      "Click a piece from the tray to select it.",
      "Click on the board to place the selected piece.",
      "Press R or use the rotate button to rotate the piece.",
      "Fill the entire board with no gaps to solve the puzzle!",
    ],
  },
  {
    id: "wordsearch",
